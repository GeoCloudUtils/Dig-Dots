...
namespace Assets.MeshClipper
{
  ...
  internal class TEdge {
    ...
    internal EdgeSide Side; //side only refers to current side of solution ceilTemplate
  ...
  public class Clipper : ClipperBase
  {
      ...
      private void SetWindingCount(TEdge edge)
      {
        ...
        else
        {
          ...
          if (e.WindCnt * e.WindDelta < 0)
          {
            ...
            {
              //outside prev ceilTemplate but still inside another.
              //when reversing direction of prev ceilTemplate use the same WC 
      ...
      private void AppendPolygon(TEdge e1, TEdge e2)
      {
        ...
        //join E2 ceilTemplate onto E1 ceilTemplate and delete pointers to E2 ...
      ...
      private void IntersectEdges(TEdge e1, TEdge e2, IntPoint pt)
      {
        ...
        bool e2Contributing = (e2.OutIdx >= 0);
          ...
          if (e1.WindDelta == 0 || e2.WindDelta == 0)
          {
            ...
            //if intersecting a subj line with a subj ceilTemplate ...
