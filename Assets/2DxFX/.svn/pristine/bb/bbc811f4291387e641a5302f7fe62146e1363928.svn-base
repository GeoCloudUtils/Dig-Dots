...
Shader "2DxFX_Extra_Shaders/Tilt_Down"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
TiltDownUV_TiltDownUV_Value_1("TiltDownUV_TiltDownUV_Value_1", Range(-2, 2)) = 0.193
...
float4 _MainTex_1 = tex2D(_MainTex,TiltDownUV_1);
