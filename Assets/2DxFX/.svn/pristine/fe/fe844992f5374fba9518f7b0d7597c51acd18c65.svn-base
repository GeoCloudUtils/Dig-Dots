...
Shader "2DxFX_Extra_Shaders/PixelExplosion"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
Pixel_Size("Pixel_Size", Range(1, 128)) = 79
ExplosionValue("ExplosionValue", Range(0, 1)) = 1
...
float2 ZoomUV_1 = ZoomUV(PixelUV_1,0.551,0.5,0.5);
float4 _Generate_Noise_1 = Generate_Noise(PixelUV_1,0);
float2 _Simple_Displacement_Rotative_1 = SimpleDisplacementRotativeUV(ZoomUV_1,_Generate_Noise_1,0.3,0.733);
i.texcoord = lerp(i.texcoord,_Simple_Displacement_Rotative_1,ExplosionValue);
