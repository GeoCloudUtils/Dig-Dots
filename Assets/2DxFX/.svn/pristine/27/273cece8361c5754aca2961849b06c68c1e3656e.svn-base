...
Shader "2DxFX_Extra_Shaders/NoiseBlur_Horizontal"
{
Properties
{
...
float2 _Simple_Displacement_1 = SimpleDisplacementUV(i.texcoord,_Generate_Line_1.r*_Generate_Line_1.a,0,Displacement_Value);
