...
Shader "2DxFX_Extra_Shaders/CircleHole"
{
Properties
{
...
float4 _CircleHole_1 = Circle_Hole(_MainTex_1,i.texcoord,_CircleHole_PosX_1,_CircleHole_PosY_1,_CircleHole_Size_1,_CircleHole_Dist_1);
